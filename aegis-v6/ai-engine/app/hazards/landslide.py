"""
Shallow landslide and debris-flow risk estimator.  Key inputs are slope
angle (derived from SRTM DEM), antecedent rainfall over 72 hours, and
soil saturation from ERA5 reanalysis.

Trained on events from the NASA Global Landslide Catalog across six
countries.  Outputs a categorical risk level plus a map-ready GeoJSON
polygon of the susceptible zone when spatial mode is enabled.
"""
