"""
Severe convective weather predictor covering high winds, lightning, and
hail.  The feature set mirrors operational meteorology: CAPE (convective
available potential energy), wind shear, dewpoint depression, and surface
pressure gradient.

Outputs an hourly risk timeline for the next 48 hours so the map UI can
animate the approaching threat on a time slider.
"""
