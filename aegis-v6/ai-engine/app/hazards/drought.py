"""
Predicts drought severity and water stress levels by combining precipitation
deficit, soil moisture, and evapotranspiration data.  Uses a 90-day rolling
window to capture slow-onset conditions that shorter-term models miss.

The trained pipeline lives in model_registry/drought/ and is loaded once at
import time.  SHAP values highlight which input drove the score so operators
can prioritise water-conservation advisories.
"""
