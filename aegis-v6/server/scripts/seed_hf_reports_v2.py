...
HEATWAVE_REPORTS = [
    ...
    ("Office workers sent home as building has no air conditioning and hit 35C inside", "medium", "extreme_heat"),
    ("Night temperatures not dropping below 25C, sleep disruption widespread", "high", "extreme_heat"),
    ...
    ("Record overnight temperature of 27C recorded at observing station", "high", "extreme_heat"),
    ...
    ("Fourth consecutive day above 35C, unprecedented for this region", "critical", "extreme_heat"),
]
...
WILDFIRE_REPORTS = [
    ...
    ("Smoke visible from miles away as grassland fire burns unchecked", "critical", "wildfire"),
    ...
    ("Fire break being cut to protect woodland from advancing wildfire", "high", "wildfire"),
    ("Arson suspected as multiple fires start simultaneously on moor", "critical", "wildfire"),
    ("Dry lightning ignited forest fire during drought conditions", "critical", "wildfire"),
    ("Barbecue in dry conditions caused grass fire at picnic area", "medium", "wildfire"),
    ("Fire crews from three counties deployed to major wildfire", "critical", "wildfire"),
    ("Helicopter water bombing operations ongoing over forest fire", "critical", "wildfire"),
...
async def main():
    ...
    print("Seeding AEGIS with realistic disaster reports...")
            ...
            for v in range(n_variants):
                ...
                try:
                    await conn.execute("""
                        ...
                        VALUES ($1, $2, $3, $4, $5, $6::report_severity, 
                            ST_SetSRID(ST_MakePoint($7, $8), 4326), $9, 
                            'verified', 'Curated Dataset', $10, $11)
                    """, report_id, report_num, category, subtype, final_desc,
                         severity, lon, lat, loc_name,
