...
DISPLAY_TYPE_MAP = {
    ...
    ('flood', 'surface_water'): 'Surface Water Flooding',
    ('flood', 'coastal'): 'Coastal Flood',
    ('drought', 'water_shortage'): 'Water Shortage',
    ('drought', 'agricultural'): 'Agricultural Drought', 
    ('drought', 'environmental'): 'Environmental Drought',
    ('drought', 'dry_conditions'): 'Dry Conditions',
    ('heatwave', 'extreme_heat'): 'Heat Emergency',
    ('heatwave', 'infrastructure'): 'Heat Infrastructure',
    ('heatwave', 'health'): 'Heat Health Alert',
    ('heatwave', 'warm_weather'): 'Warm Weather',
    ('heatwave', 'environmental'): 'Heat Environmental',
    ('storm', 'wind'): 'Wind Storm',
    ('storm', 'thunderstorm'): 'Thunderstorm',
    ('storm', 'tornado'): 'Tornado',
    ('wildfire', 'wildfire'): 'Wildfire',
    ('other', 'infrastructure'): 'Infrastructure',
    ('other', 'safety'): 'Safety Hazard',
...
FLOOD_REPORTS = [
    ...
    ("Burst water main causing street flooding", "medium", "surface_water"),
...
DROUGHT_REPORTS = [
    ...
    ("Water pressure dropping in parts of the town, conservation appeal", "medium", "water_shortage"),
    ...
    ("Record temperatures combined with no rain causing water stress", "high", "water_shortage"),
...
HEATWAVE_REPORTS = [
    ("Temperature hit 38C today, hottest day on record for the area", "critical", "extreme_heat"),
    ...
    ("Minor warmth, pleasant summer day around 28C", "low", "warm_weather"),
    ...
    ("Office workers sent home, building hit 35C inside with no AC", "medium", "extreme_heat"),
    ("Night temperatures not dropping below 25C, sleep disruption", "high", "extreme_heat"),
    ("Bins collection suspended due to extreme heat worker safety", "medium", "extreme_heat"),
    ("Grass fire on common land, started by glass in hot sun", "high", "infrastructure"),
    ("Zoo animals given ice blocks and shade shelters", "medium", "extreme_heat"),
    ("Water demand spike causing low pressure in some areas", "high", "infrastructure"),
    ("Record overnight temperature of 27C at observing station", "high", "extreme_heat"),
    ...
    ("Public pool overwhelmed with visitors seeking cooling", "medium", "extreme_heat"),
    ("Farm livestock in distress, ventilation systems struggling", "high", "extreme_heat"),
    ("Power grid strained as AC units run at maximum", "critical", "infrastructure"),
    ...
    ("National Parks seeing increased litter near water", "low", "extreme_heat"),
    ("Fourth consecutive day above 35C, unprecedented", "critical", "extreme_heat"),
]

STORM_REPORTS = [
    ("Severe gale bringing down trees, power lines damaged", "critical", "wind"),
    ("Thunderstorm with large hail, cars damaged in car park", "high", "thunderstorm"),
    ...
    ("Tornado touched down briefly, several outbuildings destroyed", "critical", "tornado"),
    ("Storm surge along east coast, coastal properties at risk", "critical", "wind"),
    ("Power outages affecting 10000 homes after overnight storm", "high", "wind"),
    ...
    ("Severe thunderstorm warning with risk of flooding", "high", "thunderstorm"),
    ...
    ("Lightning causing power surges, electronics damaged", "medium", "thunderstorm"),
    ("Festival site evacuated due to severe thunderstorm", "high", "thunderstorm"),
    ("Flying trampoline and garden furniture in residential area", "medium", "wind"),
    ("Ships in harbour ordered not to sail due to storm", "high", "wind"),
    ("Multiple 999 calls about wind damage across town", "high", "wind"),
    ...
    ("Airport closed temporarily due to crosswind limits", "high", "wind"),
    ("Roof peeled off industrial building, contents exposed", "critical", "wind"),
    ("Moderate winds causing minor disruption, some trains delayed", "low", "wind"),
    ("Storm damage assessment teams deployed", "medium", "wind"),
...
WILDFIRE_REPORTS = [
    ("Large wildfire spreading across heathland, homes threatened", "critical", "wildfire"),
    ("Controlled burn got out of hand, fire service attending", "high", "wildfire"),
    ("Smoke visible from miles away as grassland fire burns", "critical", "wildfire"),
    ("Small campfire caused brush fire, quickly contained", "medium", "wildfire"),
    ("Peat fire burning underground, very difficult to extinguish", "critical", "wildfire"),
    ("Wildfire approaching village, voluntary evacuation advised", "critical", "wildfire"),
    ("Fire break being cut to protect woodland from wildfire", "high", "wildfire"),
    ("Arson suspected as multiple fires start simultaneously", "critical", "wildfire"),
    ("Dry lightning ignited forest fire during drought", "critical", "wildfire"),
    ("Barbecue caused grass fire at picnic area", "medium", "wildfire"),
    ("Fire crews from three counties deployed to major wildfire", "critical", "wildfire"),
    ("Helicopter water bombing operations ongoing", "critical", "wildfire"),
    ("Minor stubble burn drifted into hedgerow, quickly put out", "low", "wildfire"),
    ("Air quality warning as smoke from wildfire drifts over city", "high", "wildfire"),
    ("Historic woodland damaged by out of control wildfire", "critical", "wildfire"),
]

OTHER_REPORTS = [
    ("Large pothole on high street, no injuries", "low", "infrastructure"),
    ("Tree fallen across path in local park, council notified", "low", "misc"),
    ("Building site concern, exposed wiring near footpath", "medium", "safety"),
    ...
    ("Community clean-up event this weekend", "low", "misc"),
    ("Suspicious smell from storm drain, possibly chemical", "medium", "environmental"),
    ("Abandoned vehicle on flood plain, could be hazard", "low", "misc"),
    ("Road surface crumbling and dangerous for cyclists", "medium", "infrastructure"),
    ("Air quality poor due to nearby industrial fire", "high", "environmental"),
    ("Noise complaint about construction outside hours", "low", "misc"),
    ("Water discolouration in tap water, council investigating", "medium", "safety"),
...
UK_LOCATIONS = [
    (51.5074, -0.1278, "London"), (53.4808, -2.2426, "Manchester"),
    (52.4862, -1.8904, "Birmingham"), (55.9533, -3.1883, "Edinburgh"),
    (51.4545, -2.5879, "Bristol"), (53.8008, -1.5491, "Leeds"),
    (54.9783, -1.6178, "Newcastle"), (52.6309, -1.1397, "Leicester"),
    (50.9097, -1.4044, "Southampton"), (50.3755, -4.1427, "Plymouth"),
    (51.8813, -2.2447, "Gloucester"), (52.2053, 0.1218, "Cambridge"),
    (51.7520, -1.2577, "Oxford"), (56.4907, -2.9916, "Dundee"),
    (55.8642, -4.2518, "Glasgow"), (51.4816, -3.1791, "Cardiff"),
    (52.9548, -1.1581, "Nottingham"), (53.4084, -2.9916, "Liverpool"),
    (50.7184, -1.8800, "Bournemouth"), (54.5973, -5.9301, "Belfast"),
]

async def main():
    conn = await asyncpg.connect(DB_URL)
    print("Seeding AEGIS with curated disaster reports (v3)...")
    
    categories = [
        ('flood', FLOOD_REPORTS), ('drought', DROUGHT_REPORTS),
        ('heatwave', HEATWAVE_REPORTS), ('storm', STORM_REPORTS),
        ('wildfire', WILDFIRE_REPORTS), ('other', OTHER_REPORTS),
    ]
    ...
    for category, reports in categories:
        for desc, severity, subtype in reports:
            ...
            for v in range(n_variants):
                ...
                variants = [desc, f"{desc}. Near {loc_name}.", f"{loc_name}: {desc}"]
                final_desc = rng.choice(variants)
                
                display_type = DISPLAY_TYPE_MAP.get((category, subtype), 'Incident')
                
                try:
                    await conn.execute("""
                        INSERT INTO reports (id, report_number, incident_category, incident_subtype, 
                            display_type, description, severity, coordinates, location_text, 
                            status, reporter_name, reporter_ip, created_at)
                        VALUES ($1, $2, $3, $4, $5, $6, $7::report_severity, 
                            ST_SetSRID(ST_MakePoint($8, $9), 4326), $10, 
                            'verified', 'Curated Dataset', $11, $12)
                    """, uuid.uuid4(), f"RPT-{uuid.uuid4().hex[:12].upper()}", 
                         category, subtype, display_type, final_desc, severity,
                         lon, lat, loc_name,
    ...
    print(f"\nInserted {inserted} new reports ({errors} errors)")
