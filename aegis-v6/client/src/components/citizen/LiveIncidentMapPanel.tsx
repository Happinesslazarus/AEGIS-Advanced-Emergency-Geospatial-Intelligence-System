...
const CATEGORIES: CategoryDef[] = [
  { key: 'all', label: 'All', icon: Activity, color: 'text-gray-600 dark:text-gray-300', bg: 'bg-gray-100 dark:bg-gray-700', match: () => true },
  ...
  return (
    <div className="glass-card rounded-2xl border border-gray-200/60 dark:border-gray-700/40 overflow-hidden shadow-xl shadow-gray-900/5 dark:shadow-black/20">
      ...
      >
        ...
        {expanded ? <ChevronUp className="w-4 h-4 text-gray-400 dark:text-gray-300 flex-shrink-0" /> : <ChevronDown className="w-4 h-4 text-gray-400 dark:text-gray-300 flex-shrink-0" />}
      </button>
        ...
        <>
                    ...
                    <button
                      ...
                      className={`flex items-center gap-1 px-2.5 py-1.5 rounded-lg text-[10px] font-bold whitespace-nowrap transition-all flex-shrink-0 ${
                        active
                          ...
                          : 'text-gray-500 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-800/50'
                      }`}
                    >
          ...
          <div className="px-3 py-2 border-t border-gray-100 dark:border-gray-800/50">
            <div className="grid grid-cols-3 sm:grid-cols-5 gap-2">
              ...
              <div className="bg-white/80 dark:bg-gray-800/40 rounded-xl p-2 text-center border border-gray-100 dark:border-gray-700/30">
                ...
                <div className="text-[8px] font-semibold text-gray-400 dark:text-gray-300 uppercase tracking-wider mt-0.5">Active</div>
              </div>
              {/* Critical */}
              <div className={`rounded-xl p-2 text-center border ${stats.critical > 0 ? 'bg-red-50/80 dark:bg-red-950/20 border-red-200/50 dark:border-red-800/30' : 'bg-white/80 dark:bg-gray-800/40 border-gray-100 dark:border-gray-700/30'}`}>
                <AlertTriangle className={`w-3.5 h-3.5 mx-auto mb-0.5 ${stats.critical > 0 ? 'text-red-500 animate-pulse' : 'text-gray-400 dark:text-gray-300'}`} />
                ...
                <div className="text-[8px] font-semibold text-gray-400 dark:text-gray-300 uppercase tracking-wider mt-0.5">Critical</div>
              </div>
              {/* Verified */}
              <div className="bg-white/80 dark:bg-gray-800/40 rounded-xl p-2 text-center border border-gray-100 dark:border-gray-700/30">
                ...
                <div className="text-[8px] font-semibold text-gray-400 dark:text-gray-300 uppercase tracking-wider mt-0.5">Verified</div>
              </div>
              {/* Resolved */}
              <div className="bg-white/80 dark:bg-gray-800/40 rounded-xl p-2 text-center border border-gray-100 dark:border-gray-700/30">
                ...
                <div className="text-[8px] font-semibold text-gray-400 dark:text-gray-300 uppercase tracking-wider mt-0.5">Resolved</div>
              </div>
              {/* Trend */}
              <div className="bg-white/80 dark:bg-gray-800/40 rounded-xl p-2 text-center border border-gray-100 dark:border-gray-700/30">
          ...
          <div className="relative border-t border-gray-100 dark:border-gray-800/50">
                ...
                <div className="bg-white/95 dark:bg-gray-900/95 backdrop-blur-xl rounded-xl border border-gray-200/60 dark:border-gray-700/40 shadow-2xl overflow-hidden flex flex-col max-h-full">
                      ...
                      return (
                        ...
                        >
                          ...
                          <div className="flex-1 min-w-0">
                            ...
                            <p className="text-[9px] text-gray-500 dark:text-gray-300 truncate">{item.location}</p>
                            <div className="flex items-center gap-1.5 mt-0.5">
                              <span className="text-[8px] font-medium text-gray-400 dark:text-gray-300">{timeAgoShort(item.timestamp)}</span>
                              {item.distance !== null && (
                                <span className="text-[8px] font-medium text-gray-400 dark:text-gray-300">{item.distance < 1 ? `${Math.round(item.distance * 1000)}m` : `${item.distance.toFixed(1)}km`}</span>
                              )}
                  ...
                  {feedItems.length > 15 && (
                    <div className="px-2.5 py-1.5 border-t border-gray-100 dark:border-gray-800/50 text-center flex-shrink-0">
                      <span className="text-[9px] font-semibold text-gray-400 dark:text-gray-300">+{feedItems.length - 15} more</span>
                    </div>
                  )}
                </div>
              </div>
            ...
            {!showFeed && (
              ...
              >
                <Eye className="w-3.5 h-3.5 text-gray-500 dark:text-gray-300" />
              </button>
            )}
          </div>
          ...
          <div className="flex items-center justify-between px-3 py-2 border-t border-gray-100 dark:border-gray-800/50 bg-gray-50/50 dark:bg-gray-900/30">
            ...
            {/* Center info */}
            {userPosition && (
              <div className="flex items-center gap-1 text-[9px] font-medium text-gray-500 dark:text-gray-300">
