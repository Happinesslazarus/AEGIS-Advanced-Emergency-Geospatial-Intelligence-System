...
const es: TranslationMap = withEnBase({
  ...
  'admin.welcome.commandCentre': 'Bienvenido a tu Centro de Comando AEGIS.',
  'admin.welcome.youHave': 'Tienes',
  'admin.welcome.unverifiedReports': 'reportes sin verificar',
  'admin.welcome.and': 'y',
  'admin.welcome.urgentIncidents': 'incidentes urgentes',
  'admin.welcome.requiringAttention': 'que requieren atención.',
  'admin.welcome.highSeverityActive': 'incidente(s) de alta gravedad activo(s)',
  'admin.welcome.view': 'Ver',
  'admin.welcome.viewReports': 'Ver Reportes',
  'admin.welcome.pending': 'pendientes',
  'admin.welcome.broadcastNow': 'Transmitir ahora',
  'admin.welcome.viewTrends': 'Ver tendencias',
  'admin.welcome.realTimeView': 'Vista en tiempo real',
  'admin.welcome.manageUsers': 'Gestionar Usuarios',
  'admin.welcome.teamCitizens': 'Equipo y ciudadanos',
  'admin.welcome.monitorStatus': 'Monitorear estado',
  'admin.welcome.active': 'activas',
  'admin.welcome.allClear': 'Sin alertas activas. Todo despejado.',
  'admin.welcome.alert': 'Alerta',
  'admin.welcome.info': 'Info',
  'admin.welcome.allAreas': 'Todas las áreas',
  'admin.welcome.viewAll': 'Ver todo',
  'admin.welcome.noReports': 'Sin reportes aún',
  'admin.welcome.report': 'Reporte',
  'admin.welcome.unknownLocation': 'Ubicación desconocida',
  'admin.welcome.highSev': 'Alta Grav.',
  'admin.welcome.withMedia': 'Con Medios',
  'admin.welcome.trapped': 'Atrapados',
  'admin.welcome.avgConf': 'Conf. Prom.',
 ...
 'citizenPage.viewFullAlerts': 'Ver página completa de alertas ->',
  ...
  'common.up': 'arriba', 'common.down': 'abajo', 'common.ago': 'hace',
  'common.minutesShort': 'm', 'common.hoursShort': 'h', 'common.daysShort': 'd',
  //LiveOps
  'liveOps.threat': 'AMENAZA', 'liveOps.local': 'LOCAL', 'liveOps.quickActions': 'Acciones Rápidas (Q)',
  'liveOps.screenshot': 'Captura', 'liveOps.exportData': 'Exportar Datos',
  'liveOps.hideThreat': 'Ocultar Amenaza', 'liveOps.showThreat': 'Mostrar Amenaza',
  'liveOps.copyCoords': 'Clic para copiar coordenadas', 'liveOps.newReport': 'Nuevo Reporte',
  'liveOps.threatCritical': 'CRÍTICO', 'liveOps.threatHigh': 'ALTO',
  'liveOps.threatElevated': 'ELEVADO', 'liveOps.threatGuarded': 'VIGILADO',
  'liveOps.threatNominal': 'NOMINAL', 'liveOps.predictions': 'Predicciones',
  'liveOps.evacuation': 'Evacuación', 'liveOps.statusBar': 'Barra de Estado',
  'liveOps.toggleHelp': 'Alternar Ayuda',
  //Location
  'location.searchPlaceholder': 'Buscar países y regiones...',
  'location.active': 'Activo:', 'location.noResults': 'Ningún país o región coincide con su búsqueda',
  'location.detailedMonitoring': 'Monitoreo detallado', 'location.countryOverview': 'Vista general del país',
  //FloodLayer
  'floodLayer.fluvialHigh': 'Inundación Fluvial (Alta)', 'floodLayer.fluvialHighDesc': 'Periodo de retorno de 1 en 10 años',
  'floodLayer.fluvialMedium': 'Inundación Fluvial (Media)', 'floodLayer.fluvialMediumDesc': 'Periodo de retorno de 1 en 200 años',
  'floodLayer.surfaceWater': 'Agua Superficial', 'floodLayer.surfaceWaterDesc': 'Inundación por agua superficial',
  'floodLayer.coastalFlood': 'Inundación Costera', 'floodLayer.coastalFloodDesc': 'Inundación costera / mareal',
  'floodLayer.prediction1h': 'Predicción: 1 Hora', 'floodLayer.prediction1hDesc': 'Extensión prevista de inundación en 1 hora',
  'floodLayer.prediction4h': 'Predicción: 4 Horas', 'floodLayer.prediction4hDesc': 'Extensión prevista de inundación en 4 horas',
  'floodLayer.prediction6h': 'Predicción: 6 Horas', 'floodLayer.prediction6hDesc': 'Extensión prevista de inundación en 6 horas',
...
const fr: TranslationMap = withEnBase({
  ...
  'admin.welcome.commandCentre': 'Bienvenue dans votre Centre de Commande AEGIS.',
  'admin.welcome.youHave': 'Vous avez',
  'admin.welcome.unverifiedReports': 'rapports non vérifiés',
  'admin.welcome.and': 'et',
  'admin.welcome.urgentIncidents': 'incidents urgents',
  'admin.welcome.requiringAttention': 'nécessitant attention.',
  'admin.welcome.highSeverityActive': 'incident(s) de haute gravité actif(s)',
  'admin.welcome.view': 'Voir',
  'admin.welcome.viewReports': 'Voir les Rapports',
  'admin.welcome.pending': 'en attente',
  'admin.welcome.broadcastNow': 'Diffuser maintenant',
  'admin.welcome.viewTrends': 'Voir tendances',
  'admin.welcome.realTimeView': 'Vue en temps réel',
  'admin.welcome.manageUsers': 'Gérer les Utilisateurs',
  'admin.welcome.teamCitizens': 'Équipe et citoyens',
  'admin.welcome.monitorStatus': 'Surveiller le statut',
  'admin.welcome.active': 'actives',
  'admin.welcome.allClear': 'Aucune alerte active. Tout est clair.',
  'admin.welcome.alert': 'Alerte',
  'admin.welcome.info': 'Info',
  'admin.welcome.allAreas': 'Toutes les zones',
  'admin.welcome.viewAll': 'Voir tout',
  'admin.welcome.noReports': 'Aucun rapport pour le moment',
  'admin.welcome.report': 'Rapport',
  'admin.welcome.unknownLocation': 'Emplacement inconnu',
  'admin.welcome.highSev': 'Grav. Haute',
  'admin.welcome.withMedia': 'Avec Médias',
  'admin.welcome.trapped': 'Piégés',
  'admin.welcome.avgConf': 'Conf. Moy.',
 ...
 'citizenPage.viewFullAlerts': 'Voir toutes les alertes ->',
  ...
  'common.up': 'hausse', 'common.down': 'baisse', 'common.ago': 'il y a',
  'common.minutesShort': 'm', 'common.hoursShort': 'h', 'common.daysShort': 'j',
  //LiveOps
  'liveOps.threat': 'MENACE', 'liveOps.local': 'LOCAL', 'liveOps.quickActions': 'Actions Rapides (Q)',
  'liveOps.screenshot': 'Capture', 'liveOps.exportData': 'Exporter les Données',
  'liveOps.hideThreat': 'Masquer Menace', 'liveOps.showThreat': 'Afficher Menace',
  'liveOps.copyCoords': 'Cliquez pour copier les coordonnées', 'liveOps.newReport': 'Nouveau Rapport',
  'liveOps.threatCritical': 'CRITIQUE', 'liveOps.threatHigh': 'ÉLEVÉ',
  'liveOps.threatElevated': 'REHAUSSÉ', 'liveOps.threatGuarded': 'SURVEILLÉ',
  'liveOps.threatNominal': 'NOMINAL', 'liveOps.predictions': 'Prédictions',
  'liveOps.evacuation': 'Évacuation', 'liveOps.statusBar': "Barre d'État",
  'liveOps.toggleHelp': "Basculer l'Aide",
  //Location
  'location.searchPlaceholder': 'Rechercher pays et régions...',
  'location.active': 'Actif :', 'location.noResults': 'Aucun pays ou région ne correspond à votre recherche',
  'location.detailedMonitoring': 'Surveillance détaillée', 'location.countryOverview': "Vue d'ensemble du pays",
  //FloodLayer
  'floodLayer.fluvialHigh': 'Inondation Fluviale (Élevée)', 'floodLayer.fluvialHighDesc': 'Période de retour de 1 sur 10 ans',
  'floodLayer.fluvialMedium': 'Inondation Fluviale (Moyenne)', 'floodLayer.fluvialMediumDesc': 'Période de retour de 1 sur 200 ans',
  'floodLayer.surfaceWater': 'Eaux de Surface', 'floodLayer.surfaceWaterDesc': 'Inondation par eaux de surface',
  'floodLayer.coastalFlood': 'Inondation Côtière', 'floodLayer.coastalFloodDesc': 'Inondation côtière / marée',
  'floodLayer.prediction1h': 'Prédiction : 1 Heure', 'floodLayer.prediction1hDesc': "Étendue d'inondation prévue en 1 heure",
  'floodLayer.prediction4h': 'Prédiction : 4 Heures', 'floodLayer.prediction4hDesc': "Étendue d'inondation prévue en 4 heures",
  'floodLayer.prediction6h': 'Prédiction : 6 Heures', 'floodLayer.prediction6hDesc': "Étendue d'inondation prévue en 6 heures",
...
const ar: TranslationMap = withEnBase({
  ...
  'admin.welcome.commandCentre': 'مرحبًا بك في مركز قيادة AEGIS.',
  'admin.welcome.youHave': 'لديك',
  'admin.welcome.unverifiedReports': 'تقارير غير محققة',
  'admin.welcome.and': 'و',
  'admin.welcome.urgentIncidents': 'حوادث عاجلة',
  'admin.welcome.requiringAttention': 'تتطلب الانتباه.',
  'admin.welcome.highSeverityActive': 'حادث(حوادث) عالية الخطورة نشطة',
  'admin.welcome.view': 'عرض',
  'admin.welcome.viewReports': 'عرض التقارير',
  'admin.welcome.pending': 'معلقة',
  'admin.welcome.broadcastNow': 'بث الآن',
  'admin.welcome.viewTrends': 'عرض الاتجاهات',
  'admin.welcome.realTimeView': 'عرض مباشر',
  'admin.welcome.manageUsers': 'إدارة المستخدمين',
  'admin.welcome.teamCitizens': 'الفريق والمواطنين',
  'admin.welcome.monitorStatus': 'مراقبة الحالة',
  'admin.welcome.active': 'نشطة',
  'admin.welcome.allClear': 'لا توجد تنبيهات نشطة. كل شيء واضح.',
  'admin.welcome.alert': 'تنبيه',
  'admin.welcome.info': 'معلومات',
  'admin.welcome.allAreas': 'جميع المناطق',
  'admin.welcome.viewAll': 'عرض الكل',
  'admin.welcome.noReports': 'لا توجد تقارير بعد',
  'admin.welcome.report': 'تقرير',
  'admin.welcome.unknownLocation': 'موقع غير معروف',
  'admin.welcome.highSev': 'خطورة عالية',
  'admin.welcome.withMedia': 'مع وسائط',
  'admin.welcome.trapped': 'محاصرون',
  'admin.welcome.avgConf': 'متوسط الثقة',
 ...
 'citizenPage.viewFullAlerts': 'عرض جميع التنبيهات ->',
  ...
  'common.up': 'ارتفاع', 'common.down': 'انخفاض', 'common.ago': 'منذ',
  'common.minutesShort': 'د', 'common.hoursShort': 'س', 'common.daysShort': 'ي',
  //LiveOps
  'liveOps.threat': 'تهديد', 'liveOps.local': 'محلي', 'liveOps.quickActions': 'إجراءات سريعة (Q)',
  'liveOps.screenshot': 'لقطة شاشة', 'liveOps.exportData': 'تصدير البيانات',
  'liveOps.hideThreat': 'إخفاء التهديد', 'liveOps.showThreat': 'إظهار التهديد',
  'liveOps.copyCoords': 'انقر لنسخ الإحداثيات', 'liveOps.newReport': 'تقرير جديد',
  'liveOps.threatCritical': 'حرج', 'liveOps.threatHigh': 'عالٍ',
  'liveOps.threatElevated': 'مرتفع', 'liveOps.threatGuarded': 'محروس',
  'liveOps.threatNominal': 'طبيعي', 'liveOps.predictions': 'التنبؤات',
  'liveOps.evacuation': 'إخلاء', 'liveOps.statusBar': 'شريط الحالة',
  'liveOps.toggleHelp': 'تبديل المساعدة',
  //Location
  'location.searchPlaceholder': 'البحث عن البلدان والمناطق...',
  'location.active': 'نشط:', 'location.noResults': 'لا تتطابق أي بلدان أو مناطق مع بحثك',
  'location.detailedMonitoring': 'مراقبة تفصيلية', 'location.countryOverview': 'نظرة عامة على البلد',
  //FloodLayer
  'floodLayer.fluvialHigh': 'فيضان نهري (مرتفع)', 'floodLayer.fluvialHighDesc': 'فترة عودة 1 في 10 سنوات',
  'floodLayer.fluvialMedium': 'فيضان نهري (متوسط)', 'floodLayer.fluvialMediumDesc': 'فترة عودة 1 في 200 سنة',
  'floodLayer.surfaceWater': 'مياه سطحية', 'floodLayer.surfaceWaterDesc': 'فيضان مياه سطحية',
  'floodLayer.coastalFlood': 'فيضان ساحلي', 'floodLayer.coastalFloodDesc': 'فيضان ساحلي / مدّي',
  'floodLayer.prediction1h': 'تنبؤ: ساعة واحدة', 'floodLayer.prediction1hDesc': 'مدى الفيضان المتوقع في ساعة واحدة',
  'floodLayer.prediction4h': 'تنبؤ: 4 ساعات', 'floodLayer.prediction4hDesc': 'مدى الفيضان المتوقع في 4 ساعات',
  'floodLayer.prediction6h': 'تنبؤ: 6 ساعات', 'floodLayer.prediction6hDesc': 'مدى الفيضان المتوقع في 6 ساعات',
...
const zh: TranslationMap = withEnBase({
  ...
  'admin.welcome.commandCentre': '欢迎来到AEGIS指挥中心。',
  'admin.welcome.youHave': '您有',
  'admin.welcome.unverifiedReports': '未验证的报告',
  'admin.welcome.and': '和',
  'admin.welcome.urgentIncidents': '紧急事件',
  'admin.welcome.requiringAttention': '需要关注。',
  'admin.welcome.highSeverityActive': '高严重性事件活跃中',
  'admin.welcome.view': '查看',
  'admin.welcome.viewReports': '查看报告',
  'admin.welcome.pending': '待处理',
  'admin.welcome.broadcastNow': '立即广播',
  'admin.welcome.viewTrends': '查看趋势',
  'admin.welcome.realTimeView': '实时视图',
  'admin.welcome.manageUsers': '管理用户',
  'admin.welcome.teamCitizens': '团队和公民',
  'admin.welcome.monitorStatus': '监控状态',
  'admin.welcome.active': '活跃',
  'admin.welcome.allClear': '无活跃警报。一切正常。',
  'admin.welcome.alert': '警报',
  'admin.welcome.info': '信息',
  'admin.welcome.allAreas': '所有区域',
  'admin.welcome.viewAll': '查看全部',
  'admin.welcome.noReports': '暂无报告',
  'admin.welcome.report': '报告',
  'admin.welcome.unknownLocation': '未知位置',
  'admin.welcome.highSev': '高严重',
  'admin.welcome.withMedia': '含媒体',
  'admin.welcome.trapped': '被困人员',
  'admin.welcome.avgConf': '平均置信度',
 ...
 'citizenPage.viewFullAlerts': '查看所有警报 ->',
  ...
  'common.up': '上升', 'common.down': '下降', 'common.ago': '前',
  'common.minutesShort': '分', 'common.hoursShort': '时', 'common.daysShort': '天',
  //LiveOps
  'liveOps.threat': '威胁', 'liveOps.local': '本地', 'liveOps.quickActions': '快捷操作 (Q)',
  'liveOps.screenshot': '截图', 'liveOps.exportData': '导出数据',
  'liveOps.hideThreat': '隐藏威胁', 'liveOps.showThreat': '显示威胁',
  'liveOps.copyCoords': '点击复制坐标', 'liveOps.newReport': '新报告',
  'liveOps.threatCritical': '严重', 'liveOps.threatHigh': '高',
  'liveOps.threatElevated': '提升', 'liveOps.threatGuarded': '警戒',
  'liveOps.threatNominal': '正常', 'liveOps.predictions': '预测',
  'liveOps.evacuation': '疏散', 'liveOps.statusBar': '状态栏',
  'liveOps.toggleHelp': '切换帮助',
  //Location
  'location.searchPlaceholder': '搜索国家和地区...',
  'location.active': '当前:', 'location.noResults': '没有匹配的国家或地区',
  'location.detailedMonitoring': '详细监控', 'location.countryOverview': '国家概览',
  //FloodLayer
  'floodLayer.fluvialHigh': '河流洪水（高）', 'floodLayer.fluvialHighDesc': '10年一遇',
  'floodLayer.fluvialMedium': '河流洪水（中）', 'floodLayer.fluvialMediumDesc': '200年一遇',
  'floodLayer.surfaceWater': '地表水', 'floodLayer.surfaceWaterDesc': '地表水涝',
  'floodLayer.coastalFlood': '海岸洪水', 'floodLayer.coastalFloodDesc': '海岸/潮汐洪水',
  'floodLayer.prediction1h': '预测: 1小时', 'floodLayer.prediction1hDesc': '1小时内预测洪水范围',
  'floodLayer.prediction4h': '预测: 4小时', 'floodLayer.prediction4hDesc': '4小时内预测洪水范围',
  'floodLayer.prediction6h': '预测: 6小时', 'floodLayer.prediction6hDesc': '6小时内预测洪水范围',
...
const hi: TranslationMap = withEnBase({
  ...
  'admin.welcome.commandCentre': 'AEGIS कमांड सेंटर में आपका स्वागत है।',
  'admin.welcome.youHave': 'आपके पास',
  'admin.welcome.unverifiedReports': 'असत्यापित रिपोर्ट',
  'admin.welcome.and': 'और',
  'admin.welcome.urgentIncidents': 'अत्यावश्यक घटनाएं',
  'admin.welcome.requiringAttention': 'ध्यान देने की आवश्यकता है।',
  'admin.welcome.highSeverityActive': 'उच्च गंभीरता की घटना(ँ) सक्रिय',
  'admin.welcome.view': 'देखें',
  'admin.welcome.viewReports': 'रिपोर्ट देखें',
  'admin.welcome.pending': 'लंबित',
  'admin.welcome.broadcastNow': 'अभी प्रसारित करें',
  'admin.welcome.viewTrends': 'रुझान देखें',
  'admin.welcome.realTimeView': 'रीयल-टाइम दृश्य',
  'admin.welcome.manageUsers': 'उपयोगकर्ता प्रबंधन',
  'admin.welcome.teamCitizens': 'टीम और नागरिक',
  'admin.welcome.monitorStatus': 'स्थिति निगरानी',
  'admin.welcome.active': 'सक्रिय',
  'admin.welcome.allClear': 'कोई सक्रिय अलर्ट नहीं। सब ठीक है।',
  'admin.welcome.alert': 'अलर्ट',
  'admin.welcome.info': 'जानकारी',
  'admin.welcome.allAreas': 'सभी क्षेत्र',
  'admin.welcome.viewAll': 'सभी देखें',
  'admin.welcome.noReports': 'अभी तक कोई रिपोर्ट नहीं',
  'admin.welcome.report': 'रिपोर्ट',
  'admin.welcome.unknownLocation': 'अज्ञात स्थान',
  'admin.welcome.highSev': 'उच्च गंभीरता',
  'admin.welcome.withMedia': 'मीडिया सहित',
  'admin.welcome.trapped': 'फंसे हुए',
  'admin.welcome.avgConf': 'औसत विश्वास',
...
const pt: TranslationMap = withEnBase({
  ...
  'admin.welcome.commandCentre': 'Bem-vindo ao seu Centro de Comando AEGIS.',
  'admin.welcome.youHave': 'Você tem',
  'admin.welcome.unverifiedReports': 'relatórios não verificados',
  'admin.welcome.and': 'e',
  'admin.welcome.urgentIncidents': 'incidentes urgentes',
  'admin.welcome.requiringAttention': 'que requerem atenção.',
  'admin.welcome.highSeverityActive': 'incidente(s) de alta gravidade ativo(s)',
  'admin.welcome.view': 'Ver',
  'admin.welcome.viewReports': 'Ver Relatórios',
  'admin.welcome.pending': 'pendentes',
  'admin.welcome.broadcastNow': 'Transmitir agora',
  'admin.welcome.viewTrends': 'Ver tendências',
  'admin.welcome.realTimeView': 'Visualização em tempo real',
  'admin.welcome.manageUsers': 'Gerenciar Usuários',
  'admin.welcome.teamCitizens': 'Equipe e cidadãos',
  'admin.welcome.monitorStatus': 'Monitorar status',
  'admin.welcome.active': 'ativas',
  'admin.welcome.allClear': 'Sem alertas ativos. Tudo limpo.',
  'admin.welcome.alert': 'Alerta',
  'admin.welcome.info': 'Info',
  'admin.welcome.allAreas': 'Todas as áreas',
  'admin.welcome.viewAll': 'Ver tudo',
  'admin.welcome.noReports': 'Nenhum relatório ainda',
  'admin.welcome.report': 'Relatório',
  'admin.welcome.unknownLocation': 'Localização desconhecida',
  'admin.welcome.highSev': 'Grav. Alta',
  'admin.welcome.withMedia': 'Com Mídia',
  'admin.welcome.trapped': 'Presos',
  'admin.welcome.avgConf': 'Conf. Méd.',
...
const pl: TranslationMap = withEnBase({
  ...
  'admin.welcome.commandCentre': 'Witaj w Centrum Dowodzenia AEGIS.',
  'admin.welcome.youHave': 'Masz',
  'admin.welcome.unverifiedReports': 'niezweryfikowanych raportów',
  'admin.welcome.and': 'i',
  'admin.welcome.urgentIncidents': 'pilnych incydentów',
  'admin.welcome.requiringAttention': 'wymagających uwagi.',
  'admin.welcome.highSeverityActive': 'incydent(y) o wysokiej wadze aktywne',
  'admin.welcome.view': 'Zobacz',
  'admin.welcome.viewReports': 'Zobacz Raporty',
  'admin.welcome.pending': 'oczekujące',
  'admin.welcome.broadcastNow': 'Nadaj teraz',
  'admin.welcome.viewTrends': 'Zobacz trendy',
  'admin.welcome.realTimeView': 'Widok w czasie rzeczywistym',
  'admin.welcome.manageUsers': 'Zarządzaj Użytkownikami',
  'admin.welcome.teamCitizens': 'Zespół i obywatele',
  'admin.welcome.monitorStatus': 'Monitoruj status',
  'admin.welcome.active': 'aktywne',
  'admin.welcome.allClear': 'Brak aktywnych alertów. Wszystko czyste.',
  'admin.welcome.alert': 'Alert',
  'admin.welcome.info': 'Info',
  'admin.welcome.allAreas': 'Wszystkie obszary',
  'admin.welcome.viewAll': 'Zobacz wszystko',
  'admin.welcome.noReports': 'Brak raportów',
  'admin.welcome.report': 'Raport',
  'admin.welcome.unknownLocation': 'Nieznana lokalizacja',
  'admin.welcome.highSev': 'Wysoka Waga',
  'admin.welcome.withMedia': 'Z Mediami',
  'admin.welcome.trapped': 'Uwięzieni',
  'admin.welcome.avgConf': 'Śr. Pewność',
...
const ur: TranslationMap = withEnBase({
  ...
  'admin.welcome.commandCentre': 'AEGIS کمانڈ سینٹر میں خوش آمدید۔',
  'admin.welcome.youHave': 'آپ کے پاس',
  'admin.welcome.unverifiedReports': 'غیر تصدیق شدہ رپورٹیں',
  'admin.welcome.and': 'اور',
  'admin.welcome.urgentIncidents': 'فوری واقعات',
  'admin.welcome.requiringAttention': 'توجہ درکار ہے۔',
  'admin.welcome.highSeverityActive': 'اعلیٰ شدت کے واقعات فعال',
  'admin.welcome.view': 'دیکھیں',
  'admin.welcome.viewReports': 'رپورٹیں دیکھیں',
  'admin.welcome.pending': 'زیر التوا',
  'admin.welcome.broadcastNow': 'ابھی نشر کریں',
  'admin.welcome.viewTrends': 'رجحانات دیکھیں',
  'admin.welcome.realTimeView': 'براہ راست منظر',
  'admin.welcome.manageUsers': 'صارفین کا انتظام',
  'admin.welcome.teamCitizens': 'ٹیم اور شہری',
  'admin.welcome.monitorStatus': 'حالت کی نگرانی',
  'admin.welcome.active': 'فعال',
  'admin.welcome.allClear': 'کوئی فعال الرٹ نہیں۔ سب ٹھیک ہے۔',
  'admin.welcome.alert': 'الرٹ',
  'admin.welcome.info': 'معلومات',
  'admin.welcome.allAreas': 'تمام علاقے',
  'admin.welcome.viewAll': 'سب دیکھیں',
  'admin.welcome.noReports': 'ابھی تک کوئی رپورٹ نہیں',
  'admin.welcome.report': 'رپورٹ',
  'admin.welcome.unknownLocation': 'نامعلوم مقام',
  'admin.welcome.highSev': 'اعلیٰ شدت',
  'admin.welcome.withMedia': 'میڈیا کے ساتھ',
  'admin.welcome.trapped': 'پھنسے ہوئے',
  'admin.welcome.avgConf': 'اوسط اعتماد',
