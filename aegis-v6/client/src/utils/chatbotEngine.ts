...
const KW: { kw: string[]; i: Intent }[] = [
  ...
  { kw: ['suicide','suicidal','kill myself','want to die','wanna die','gonna die','feel like dying','feel like dieing','feel like i\'m dying','feel like i am dying','i am dying','i\'m dying','end it all','end my life','self harm','self-harm','cutting','overdose','don\'t want to live','no reason to live','better off dead','hate myself','worthless','hurt myself','harm myself','tired of living','can\'t do this anymore','cant do this anymore','life not worth','what\'s the point of living','dieing','dyin'], i: I.CRISIS_MH },
  { kw: ['trauma','ptsd','nightmare','flashback','cant sleep','depressed','depression','hopeless','numb','dissociating','flashbacks','intrusive thoughts'], i: I.TRAUMA },
  { kw: ['lost someone','lost my home','lost everything','grief','mourning','devastated','miss them','died','death','bereavement','funeral'], i: I.GRIEF },
  { kw: ['mental health','stressed','stress','overwhelmed','coping','struggling','support','counselling','therapy','not ok','not okay','breaking down','lonely','isolated','can\'t cope','falling apart','empty','alone'], i: I.MENTAL },
  { kw: ['abuse','abused','domestic violence','being hit','being beaten','molested','assault','raped','trafficking'], i: I.CRISIS_MH },
  { kw: ['eating disorder','anorexia','bulimia','addiction','addicted','alcoholic','substance abuse','drug problem'], i: I.MENTAL },
  ...
  { kw: ['who created','who made','who built','happiness','lazarus','aegis','supervisor','shahana','bano','favourite quote','favorite quote','quote from','who are you','created you','your creator','how old','birthday','born'], i: I.ABOUT },
]
...
const R: Record<Intent, string> = {
  ...
  [I.CRISIS_MH]: "**Thank you for telling me. That took real courage.**\n\nPlease reach out to someone right now:\n\n**IMMEDIATE HELP (free, confidential, 24/7):**\n• **Samaritans:** 116 123 (call free, anytime)\n• **Crisis Text Line:** Text SHOUT to 85258\n• **NHS Urgent Mental Health:** 111, press 2\n• **Childline (under 18):** 0800 1111\n• **Domestic Abuse Helpline:** 0808 2000 247\n• **PAPYRUS (young people):** 0800 068 4141\n\n**You are not broken.** What you're feeling is real, and it matters. You don't have to carry this alone.\n\n**While you're here, try this grounding exercise:**\nPlace both feet on the ground. Take a slow breath in for 4 counts... hold for 4... out for 4. Name 5 things you can see around you right now.\n\n**Asking for help is not weakness — it is strength.** You reached out today, and that tells me something important: you haven't given up.\n\n*This is an offline response. When connected, our AI therapist can provide personalised crisis support.*",
  ...
  [I.ABOUT]: "I'm **AEGIS** — Advanced Emergency Geospatial Intelligence System.\n\n**Created by:** Happiness Ada Lazarus, a final-year BSc Computer Science student at Robert Gordon University, Aberdeen, Scotland.\n\n**Academic Supervisor:** Dr. Shahana Bano\n\n**Happiness's favourite quote from her supervisor:**\n> *\"Why should you give up when Shahana Bano is your supervisor?\"* \n> — Dr. Shahana Bano\n\nI'm currently in **offline mode** so my answers are limited. When connected to the AI engine, I can tell you much more about my creator and capabilities!",
